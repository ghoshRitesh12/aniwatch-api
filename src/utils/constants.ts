...
const domain = process.env.DOMAIN || 'aniwatch.to'

export const SRC_BASE_URL = `https://${domain}`;
export const SRC_AJAX_URL = `https://${domain}/ajax`;
export const SRC_HOME_URL = `https://${domain}/home`;
export const SRC_SEARCH_URL = `https://${domain}/search`;
